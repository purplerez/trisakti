...
if (isset($_GET['username'])) {
    ...
    if (!$data) {
        echo "<script>alert('Data tidak ditemukan');window.location='sidebar.php';</script>";
        exit();
    }
} else {
    echo "<script>alert('Pilih username yang akan diedit');window.location='sidebar.php';</script>";
    exit();
}
?>
<!DOCTYPE html>
